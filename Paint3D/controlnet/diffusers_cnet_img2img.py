...
from ..pipeline import StableDiffusionControlNetImg2ImgPipeline
...
class img2imgControlNet():
    def __init__(self, config, torch_dtype=torch.float16):
        ...
        pipe = StableDiffusionControlNetImg2ImgPipeline.from_pretrained(config.sd_model_key, controlnet=controlnet_list, torch_dtype=torch_dtype).to("cuda")
